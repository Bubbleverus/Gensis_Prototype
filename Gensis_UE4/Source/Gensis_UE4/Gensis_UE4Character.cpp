...
void AGensis_UE4Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AGensis_UE4Character::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AGensis_UE4Character::MoveForward(float Value)
{
...
void AGensis_UE4Character::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
